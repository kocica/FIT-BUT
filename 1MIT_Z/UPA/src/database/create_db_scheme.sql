...
-----------------------------------------------
DROP TABLE TABLE_FOLDER CASCADE CONSTRAINT;
DROP TABLE TABLE_IMAGE CASCADE CONSTRAINT;
DROP TABLE TABLE_GEOMETRY CASCADE CONSTRAINT;

DROP SEQUENCE FOLDER_SEQ_ID;
DROP SEQUENCE IMAGE_SEQ_ID;
DROP SEQUENCE GEOMETRY_SEQ_ID;

-----------------------------------------------
-- Create database tables representing Folder,
-- Image and Geometry
...
-----------------------------------------------
-- Features generator for new images
-----------------------------------------------
...
INSERT INTO USER_SDO_GEOM_METADATA VALUES ( 'TABLE_GEOMETRY', 'SpatialDataObject', SDO_DIM_ARRAY( SDO_DIM_ELEMENT( 'X', 0, 150, 0.1 ), SDO_DIM_ELEMENT( 'Y', 0, 150, 0.1 ) ), NULL );
