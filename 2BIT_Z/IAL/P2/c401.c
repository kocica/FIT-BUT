...
**/
								...
								// If key is bigger, find in right tree
								if (RootPtr->Key < K)
								{
																return BSTSearch(RootPtr->RPtr, K, Content);
								}
								// If key is lower, find in left tree
...
**/
								...
								{
																/// Create new leaf
																tBSTNodePtr p = malloc(sizeof *p);
																if (p == NULL)
																{
																								// E-Failed to allocate memory on heap
																}
																// Init p
																p->BSTNodeCont = Content;
																p->Key = K;
																p->LPtr = NULL;
																p->RPtr = NULL;
																*RootPtr = p;
...
// End of recursion
								...
								{
																// We at the most right
																PtrReplaced->BSTNodeCont = (*RootPtr)->BSTNodeCont;
																PtrReplaced->Key = (*RootPtr)->Key;
								}
								else
								{
																// Call recursive with right leaf
...
// End of recursion
								...
								if ((*RootPtr)->Key == K)
								{
																...
																else if ((*RootPtr)->RPtr != NULL)
																{
																								...
																								(*RootPtr)->Key = (*RootPtr)->RPtr->Key;
																								(*RootPtr)->BSTNodeCont = (*RootPtr)->RPtr->BSTNodeCont;
																								(*RootPtr)->LPtr = tmp->LPtr;
																								(*RootPtr)->RPtr = tmp->RPtr;
																								free(tmp);
																}
																// None exists, free root
																else
																{
																								free(*RootPtr);
																								*RootPtr = NULL;
