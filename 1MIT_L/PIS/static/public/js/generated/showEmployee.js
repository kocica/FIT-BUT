...
function isGetClientResponse22(obj) {
    return true;
}
function isApiBankAccount22(obj) {
    return typeof obj == "object" && typeof obj.login == "string" && typeof obj.isTerminated == "boolean";
}
function isGetBankAccountListResponse22(obj) {
...
async function showClientInfo2() {
    ...
    var accountTab = document.getElementById("employeeTable");
