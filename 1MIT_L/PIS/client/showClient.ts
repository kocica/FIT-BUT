...
function isGetClientResponse(obj: any): obj is GetClientResponse
{
	return true
}

function isApiBankAccount(obj: any): obj is ApiBankAccount
{
...
function isGetBankAccountListResponse(obj: any): obj is GetBankAccountListResponse
{
...
async function showClientInfo()
{
	...
	let req2: GetBankAccountListRequest = {
		clientId: result.id
	}
	...
	var accountTab: HTMLTableElement = <HTMLTableElement> document.getElementById("accountTable");
